...
public class Player3_Mediator : EventMediator {
    ...
    public override void OnRegister()
    {
        ...
        dispatcher.AddListener(ViewConst.UpdateWinCards3, CallBack_UpdateWinCards);
        dispatcher.AddListener(ViewConst.ShowChongCards3, CallBack_ShowChongCards);
    }
    ...
    public override void OnRemove()
    {
        ...
        dispatcher.RemoveListener(ViewConst.UpdateWinCards3, CallBack_UpdateWinCards);
        dispatcher.RemoveListener(ViewConst.ShowChongCards3, CallBack_ShowChongCards);
    }
}
