...
public class OptionMenu_Mediator : EventMediator {
    ...
    public override void OnRegister()
    {
        ...
        View.dispatcher.AddListener(ViewConst.Click_ViewResult, CallBack_ViewResult);
    }
    public override void OnRemove()
    {
        ...
        View.dispatcher.RemoveListener(ViewConst.Click_ViewResult, CallBack_ViewResult);
    }
    private void CallBack_TimeOut(IEvent evt)
    {
        dispatcher.Dispatch(ViewConst.Click_Reset);//超时直接跳过
        CallBack_Discard();//超时直接出牌
    ...
    private void CallBack_ViewResult()
    {
        dispatcher.Dispatch(NotificationConst.Noti_ViewResult);
    }
