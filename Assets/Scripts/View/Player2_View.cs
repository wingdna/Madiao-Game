...
public class Player2_View : EventView {
    ...
    private Transform CardPos, CardPos2, CardPos3;
    ...
    private Sprite[] LoadSprites(Card[] cards)
    {
        ...
        List<Card> lcards = SortCards(cards);
        for (int i = 0; i < cards.Length; i++)
        {
            //获取图片名字
            string name = global::Card.GetSpriteName(lcards[i]);
            //加载图片
            Debug.Log(name);
    ...
    private List<Card> SortCards(Card[] cards)
    {
