...
public class OptionMenu_View : EventView {
    ...
    private Transform GameAfter;//打牌前
    ...
    private Button Btn_ViewResult;//開衝結果
    ...
    public void Init()
    {
        ...
        Text txt_Tip = Btn_Tip.transform.Find("Text").GetComponent<Text>();
        txt_Tip.text = StringFanConst.TipDiscard;
        Text txt_Discard = Btn_Discard.transform.Find("Text").GetComponent<Text>();
        txt_Discard.text = StringFanConst.DiscardCard;
        //----------------------------//
        ...
        //----------------------------//
        GameAfter = transform.Find("GameAfter");
        Btn_ViewResult = GameAfter.Find("Btn_ViewResult").GetComponent<Button>();
        Btn_ViewResult.onClick.AddListener(Click_BtnViewResult);
    ...
    public void ChangeMode(OptionMenu_Status mode)
    {
        switch (mode)
        {
            case OptionMenu_Status.CallLandlord://叫地主
                {
                    ...
                    GameAfter.gameObject.SetActive(false);
            ...
            case OptionMenu_Status.FightLandlord://斗地主，游戏中
                ...
                break;
            case OptionMenu_Status.ViewResult://斗地主，游戏中
                {
                    GameIn.gameObject.SetActive(false);
                    GameBefore.gameObject.SetActive(false);
                    GameAfter.gameObject.SetActive(true);
                    Btn_ViewResult.gameObject.SetActive(true);
                }
                break;
    ...
    private void Click_BtnViewResult()
    {
        dispatcher.Dispatch(ViewConst.Click_ViewResult);
    }
}
