...
public class NotCallCommand : EventCommand
{
    ...
    public override void Execute()
    {
        ...
        //{
        //    dispatcher.Dispatch(ViewConst.ShowPlayer2Msg, StringFanConst.NotCall);
        //}
        //if (recData.player.Name.Equals(gameData.Player3.Name))
        //{
        //    dispatcher.Dispatch(ViewConst.ShowPlayer3Msg, StringFanConst.NotCall);
        //}
        //if (recData.player.Name.Equals(gameData.Player4.Name))
        //{
        //    dispatcher.Dispatch(ViewConst.ShowPlayer4Msg, StringFanConst.NotCall);
        //}
