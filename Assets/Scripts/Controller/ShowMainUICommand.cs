...
public class ShowMainUICommand : EventCommand {
    ...
    public override void Execute()
    {
        ...
        if (canvas.Find("MainGameUI(Clone)") != null)//已经加载过了
        {
            ...
            mainUI.transform.Find("Player4").GetComponent<Player4_View>().ResetGame();
        ...
        Transform Player4 = mainUI.transform.Find("Player4");
        Player4.gameObject.AddComponent<Player4_View>();
