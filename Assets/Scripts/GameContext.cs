...
public class GameContext : MVCSContext {
    ...
    {
        injectionBinder.Bind<IMdData>().To<MdDataCenter>().ToSingleton();
    ...
    private void MapView()
    {
        ...
        mediationBinder.Bind<Player4_View>().To<Player4_Mediator>();
    ...
    private void MapController()
    {
        ...
        commandBinder.Bind(NotificationConst.Noti_Chong).To<ChongCommand>();
        commandBinder.Bind(NotificationConst.Noti_ViewResult).To<ViewResultCommand>();
        ...
        commandBinder.Bind(NotificationConst.Noti_Player4).To<Player4Command>();
        ...
        commandBinder.Bind(NotificationConst.Noti_SendUserinfo).To<SendUserinfoCommand>();
        ...
        commandBinder.Bind(NotificationConst.Noti_ContinueGame).To<ContinueGameCommand>();
        ...
        commandBinder.Bind(NotificationConst.Noti_Replay).To<ReplayCommand>();
        commandBinder.Bind(NotificationConst.Noti_StartPVE).To<StartPVECommand>();
        commandBinder.Bind(NotificationConst.Noti_StartPVP).To<StartPVPCommand>();
